...
public class myFifthFragment extends BaseFragment implements AllVideosApi.AllVideosCallbackListener {
    ...
    private static myFifthFragment fragment;

    public static myFifthFragment newInstance(String PlaylistID) {
        Bundle args = new Bundle();
        args.putString("PlaylistID", PlaylistID);
        fragment = new myFifthFragment();
