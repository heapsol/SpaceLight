...
public class myFourtFragment extends BaseFragment implements AllVideosApi.AllVideosCallbackListener {
    ...
    private static myFourtFragment fragment;

    public static myFourtFragment newInstance(String PlaylistID) {
        Bundle args = new Bundle();
        args.putString("PlaylistID", PlaylistID);
        fragment = new myFourtFragment();
